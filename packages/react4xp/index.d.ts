import { Request, PageContributions } from "@item-enonic-types/global/controller";
 ...
 */
export function render<Props extends object = object>(
  /**
...
export interface React4xp<Props extends object = object> {
   ...
   */
  renderPageContributions(options?: RenderPageContributionsParams): PageContributions;
