declare global {
  interface XpLibraries {
    "/lib/xp/project": typeof import("./index");
  }
}
 ...
 */
export function addPermissions(params: AddPermissionsParams): boolean;
 ...
 */
declare function del(params: DeleteProjectParams): boolean;
 ...
 */
export function list(): ReadonlyArray<Project>;
 ...
 */
export function modifyReadAccess(params: ModifyReadAccessParams): ModifyReadAccessResult;
 ...
 */
export function removePermissions(params: RemovePermissionsParams): boolean;
