 ...
 */
export function create(params: CreateRepoParams): RepositoryConfig;

/**
 * Creates a branch
 */
export function createBranch(params: CreateBranchParams): BranchConfig;

/**
 * Retrieves a repository
 */
export function get<Data = unknown>(id: string): RepositoryConfig<Data> | null;

/**
 * Retrieves the list of repositories
 */
export function list<Data>(): ReadonlyArray<RepositoryConfig<Data>>;

/**
 * Deletes a repository
 */
declare function del(id: string): boolean;
export { del as delete };

/**
 * Deletes a branch
 */
export function deleteBranch(params: DeleteBranchParams): BranchConfig;

/**
 * Refresh the data for the given index-type in the current repository
 */
export function refresh(params: RefreshParams): ReadonlyArray<unknown>;

/**
 * Updates a repository
 */
export function modify<Data>(params: ModifyParams<Data>): RepositoryConfig<Data>;
