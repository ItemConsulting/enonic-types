declare global {
  interface XpLibraries {
    "/lib/xp/task": typeof import("./index");
  }
}
 ...
 */
export function list(params?: ListParams): ReadonlyArray<TaskInfo>;
 ...
 */
export function progress(params: Partial<ProgressParams>): void;
 ...
 */
export function submitNamed<Config extends object = never>(params: SubmitNamedParams<Config>): string;
