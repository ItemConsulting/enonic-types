declare module "*/lib/xp/repo" {
  namespace repoLib {
    ...
    export interface CreateRepoParams {
      id: string;
      rootPermissions?: ReadonlyArray<import("/lib/xp/content").PermissionsParams>;
    ...
    export interface RepositoryConfig<Data = import("./types").EmptyObject> {
      readonly id: string;
  ...
  const repoLib: repoLib.RepoLibrary;
  export = repoLib;
}
