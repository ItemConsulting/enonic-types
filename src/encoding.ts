declare module "*/lib/text-encoding" {
  namespace textEncodingLib {
    ...
    export type ByteSource = import("/lib/xp/content").ByteSource;
  }

  const textEncodingLib: textEncodingLib.EncodingLibrary;
  export = textEncodingLib;
}
