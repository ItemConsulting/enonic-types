declare module "*/lib/notifications" {
  namespace notificationsLib {
    interface NotificationsLibrary {
      /**
    ...
    export interface KeyPair {
       ...
       */
      readonly privateKeyBytes: import("/lib/xp/content").ByteSource;

      /**
       * The public key as a binary stream.
       */
      readonly publicKeyBytes: import("/lib/xp/content").ByteSource;
    }
  ...
  const notificationsLib: notificationsLib.NotificationsLibrary;
  export = notificationsLib;
}
