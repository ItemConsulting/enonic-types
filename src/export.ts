declare module "*/lib/xp/export" {
  namespace exportLib {
    ...
    interface ExportLibrary {
       ...
       */
      importNodes(params: ImportNodesParams): ImportNodesResult;

      /**
       * Export nodes to a nodes-export.
       * Export is created in exports directory.
       */
      exportNodes(params: ExportNodesParams): ExportNodesResult;
    }
  }
  ...
  interface ImportNodesParams {
     ...
     */
    source: string | import("/lib/thymeleaf").ResourceKey;
     ...
     */
    xslt?: string | import("/lib/thymeleaf").ResourceKey;
  ...
  const exportLib: exportLib.ExportLibrary;
  export = exportLib;
}
