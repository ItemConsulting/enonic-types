declare module "*/lib/graphql-playground" {
  namespace graphQlPlaygroundLib {
    interface GraphQlPlaygroundLibrary {
      render(): string;
    }
  }
  const graphQlPlaygroundLib: graphQlPlaygroundLib.GraphQlPlaygroundLibrary;
  export = graphQlPlaygroundLib;
}

declare module "*/lib/graphql" {
  namespace graphqlLib {
    interface GraphQlLibrary {
    ...
    export type EmptyObject = import("./types").EmptyObject;
  ...
  const graphqlLib: graphqlLib.GraphQlLibrary;
  export = graphqlLib;
}
