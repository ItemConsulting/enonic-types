declare module "*/lib/xp/auditlog" {
  namespace authlogLib {
    /**
     * This library provides functions for audit log management.
     * @since 7.2.0
     */
    interface AuditLogLibrary {
      /**
       * This function creates a single audit log entry.
       */
      log<Data>(params: LogParams): LogEntry<Data>;

      /**
       * This function fetches an audit log entry.
       */
      get<Data = DefaultData>(params: GetParams): LogEntry<Data>;

      /**
       * This function searches for entries in the audit log.
       */
      find<Data = DefaultData>(params: FindParams): Array<LogEntry<Data>>;
    }
  ...
  const authlogLib: authlogLib.AuditLogLibrary;
  export = authlogLib;
}
